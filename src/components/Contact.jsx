  ...
  if (onClick) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="flex w-full items-center gap-4 rounded-3xl border border-[#DED9CF] bg-white/70 p-5 text-left shadow-sm transition hover:-translate-y-1 hover:border-[#557462]/25 hover:shadow-lg"
      >
        {content}
      </button>
    );
